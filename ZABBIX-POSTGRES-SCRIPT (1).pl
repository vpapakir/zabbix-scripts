...
sub usage {
    print "[-] $0 is a perl script designed to work with Zabbix to keep monitored PostgreSQL databases,\n";
    print "some features monitored are: connection pool, buffers, locks, checkpoints.\n";
